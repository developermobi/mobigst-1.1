...
class PurchaseController extends Controller{
	...
	public function cancelPurchaseInvoice($id){
		$getData = Purchase::cancelPurchaseInvoice($id);
	...
	public function createVcdnote($id){
		...
		if(sizeof($getCdnoteInvoiceCount) > 0){
			$data['note_no'] = "VCDN".($getCdnoteInvoiceCount[0]->count + 1);
		}else{
			$data['note_no'] = "VCDN1";
		}
	...
	public function cancelVcdnote($id){
		$getData = Purchase::cancelCdnote($id);
	...
	public function cancelAdvancePayment($id){
		$getData = Purchase::cancelAdvancePayment($id);
	...
	public function editAdvancePayment($id){
