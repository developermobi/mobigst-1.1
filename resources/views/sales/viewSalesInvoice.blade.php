...
<div class="content">
	<div class="train w3-agile">
		<div class="container">
			...
			<h2 style="margin-top: 0px;">View Goods Sales Invoice</h2>
			<div class="table-responsive" style="padding-top: 20px;">
				<form id="invoiceForm" role="form">
					...
					<table class="table table-bordered">
						...
						<tbody>
							<tr>
								<td><input type="text" class="form-control" name="invoice_no" id="invoice_no" value="{{$data['data']['invoice_data'][0]->invoice_no}}"></td>
