				...
				<form id="invoiceForm" role="form">
					...
					<table class="table table-bordered" id="item_table2">
						<tr>
							...
							<td><input type="checkbox" name="is_other_charge" id="is_other_charge" onclick="calculateTotal(this);" <?php if($data['data']['invoice_data'][0]->is_other_charge == '1'){echo "checked";}?> > Other Charges</td>
							<td><input type="checkbox" name="is_invoice_charge" id="is_invoice_charge" onclick="calculateTotal(this);" <?php if($data['data']['invoice_data'][0]->is_invoice_charge == '1'){echo "checked";}?> > Invoice Charges</td>
						</tr>
						<tr>
							...
							<td><input type="text" class="form-control invoice_charge" id="invoice_charge" name="invoice_charge" onkeyup="calculateTotal(this);" value="{{$data['data']['invoice_data'][0]->invoice_charge}}" ></td>
						</tr>
					</table>
					<table class="table table-bordered">
						<!-- <tr>
						...
						<tr>
							<td colspan="2" align="right">Loading and Packing Charges</td>
							<td><input type="text" class="form-control lp_charge" id="lp_charge" name="lp_charge" onkeyup="calculateTotal(this)" value="{{$data['data']['invoice_data'][0]->lp_charge}}"></td>
						</tr>
						<tr>
							<td colspan="2" align="right">Insurance Charges</td>
							<td><input type="text" class="form-control insurance_charge" id="insurance_charge" name="insurance_charge" onkeyup="calculateTotal(this)" value="{{$data['data']['invoice_data'][0]->insurance_charge}}"></td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="2" align="right">Invoice Charges</td>
							<td><input type="text" class="form-control invoice_charge" id="invoice_charge" name="invoice_charge" onkeyup="calculateTotal(this)" value="{{$data['data']['invoice_data'][0]->invoice_charge}}"></td>
						</tr> -->
						<tr>
...
<script src="{{URL::asset('app/js/editsalesinvoice.js')}}"></script>
