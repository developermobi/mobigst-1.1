...
<div class="content">
	<div class="train w3-agile">
		<div class="container">
			...
			<h2 style="margin-top: 0px;">View Services Sales Invoice</h2>
					...
					<table class="table table-bordered order-list">
						<thead>
							<tr>
								...
								<th rowspan="2" class="removeDiv"> Discount in %</th>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<input type="text" class="form-control unit" name="unit" id="unit" value="{{$value->unit}}" onkeyup="calculateNew(this)"/>
								</td>
							</td>
